...
const SetAlertModal = ( {fetchRoomsData, rooms, URL, setRooms}) => {
...
<SetAlertContent rooms={rooms} setRooms={setRooms} fetchRoomsData= {fetchRoomsData}  URL= {URL} onClose={() => setShowModal(false)} />
      </Modal>
    </>
  );
};
